...
export default class NewJobContainer extends React.Component {
  constructor(props) {
    ...
    this.state = {
      cie: [],
      recruiters: [],
      websiteList: ['', 'Indeed', 'Linkedin', 'ZipRecruters', 'IrishJob.ie','Email', 'NA'],  // Get from API
      typeOfPosition: ['Front End Eng', 'NodeJs Eng', 'Senior Front-end', 'Senior Backend', 'Fullstack', 'Senior Fullstack'], // Get from API
      companyNameList: [],
      data: {
        _id: undefined,
        location: undefined,
  ...
  componentDidMount() {
    this.setState({data:{...this.state.data, ...APIData}})
  }
  changeKey(key, value) {
    const tmp = {...this.state.data, [key]:value};
        ...
        <Form.Group as={Row}>
          ...
          <Col sm="10">
            <Form.Control
              ...
              required
              value={data.company}
              onChange={(e) => this.changeKey('company', e.target.value)}
            />
          </Col>
        </Form.Group>
        ...
        <Form.Group as={Row}>
          ...
          <Col sm="10">
            <Form.Control
              ...
              required
              value={data.title}
              onChange={(e) => this.changeKey('title', e.target.value)}
            />
          </Col>
        </Form.Group>
        ...
        <Form.Group as={Row}>
          ...
          <Col sm="10">
            <Form.Control
              ...
              required
              value={data.website}
              onChange={(e) => this.changeKey('website', e.target.value)}
            />
          </Col>
        </Form.Group>
        ...
        <Form.Group as={Row}>
          ...
          <Col sm="10">
            <Form.Control
              ...
              onChange={(e) => this.changeKey('description', e.target.value)}
            />
          </Col>
        </Form.Group>
        ...
        <Form.Group as={Row}>
          ...
          <Col sm="10">
            <Form.Control
              ...
              onChange={(e) => this.changeKey('application', e.target.value)}
            />
          </Col>
        </Form.Group>
        ...
        <Form.Group as={Row}>
          ...
          <Col sm="10">
            <Form.Control
              ...
              onChange={(e) => this.changeKey('cover_letter', e.target.value)}
            />
          </Col>
        </Form.Group>
